    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'rating',
                    models.PositiveIntegerField(default=50, verbose_name='Рейтинг'),
                ),
                (
                    'groups',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'author',
                    models.CharField(max_length=75, verbose_name='Автор текста'),
                ),
                (
                    'author_description',
                    models.TextField(verbose_name='Описание автора текста'),
                ),
                (
                    'teacher',
                    models.ForeignKey(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'is_required',
                    models.BooleanField(
                        verbose_name='Является ли обязательной проверкой'
                    ),
                ),
                (
                    'evaluator',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'range_of_problems',
                    models.TextField(verbose_name='Примерный круг проблем'),
                ),
                (
                    'authors_position',
                    models.TextField(verbose_name='Авторская позиция'),
                ),
                (
                    'text',
                    models.ForeignKey(
