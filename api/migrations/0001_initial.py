# Generated by Django 4.0.5 on 2022-07-02 21:26
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('week_id', models.CharField(help_text='Пример формата: 2022-2023_07, где 2022 - это начало учебного года, 2023 - конец, 07 - номер недели', max_length=12, unique=True, verbose_name='Номер недели')),
