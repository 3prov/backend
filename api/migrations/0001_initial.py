# Generated by Django 4.0.5 on 2022-07-01 23:33
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('text', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='keys', to='api.text', verbose_name='Проблемы текста')),
            ],
        ),
        migrations.AddField(
            model_name='text',
            name='week',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='tasks', to='api.week', verbose_name='Неделя'),
        ),
        migrations.CreateModel(
            name='Essay',
            fields=[
        ...
        migrations.AddField(
            model_name='user',
            name='social_network',
            field=models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='user', to='api.authsocialid', verbose_name='Социальная сеть'),
        ),
        migrations.AddField(
            model_name='user',
