...
from api.rus.evaluations.views import EvaluationFormURLGetCurrentWeekList, EssaySentenceReviewFromFormURLCreate, \
    EvaluationFormURLListView, EvaluationFormURLCreate, EvaluationFormURLView, \
    WorkDistributionToEvaluateVolunteerListView, EssaySentenceReviewFormURLView
